          ...
          <GlassCard className="overflow-hidden" glow>
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-0">
              ...
              <div className="lg:col-span-3 relative">
                <Link href={`/students/${featured.pnr}`}>
                  <div className="relative aspect-video lg:aspect-auto lg:h-full min-h-[300px] overflow-hidden group">
                    <Image
                      ...
                      alt={`${publicName(featured)} — ${latestVideo?.title || 'Story video'}`}
                      fill
                ...
                <div className="space-y-5">
                  ...
                  <p className="text-text-muted leading-relaxed">
                    {t('featured.bio', locale, {
                      name: featured.assumedFirstName,
                  ...
                  {recentVideos.length > 1 && (
                    <div>
                      <p className="text-text-muted text-xs uppercase tracking-wider mb-2">{t('featured.moreFrom', locale, { name: featured.assumedFirstName })}</p>
                ...
                <div className="mt-6">
                  <Link href={`/students/${featured.pnr}`}>
                    <Button variant="primary" size="lg" className="w-full">
                      ...
                      {t('featured.watchStory', locale, { name: featured.assumedFirstName })}
                    </Button>
                  </Link>
                </div>
              </div>
