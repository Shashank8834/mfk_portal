        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-8">
          ...
          <div className="md:col-span-1 space-y-4">
            ...
            <p className="text-text-muted text-sm leading-relaxed">
              Empowering underprivileged children through mentorship, education, and community support across Bangalore.
            </p>
            <div className="flex items-center gap-2 mt-4">
              <div className="glass px-3 py-1.5 rounded-lg flex items-center gap-2">
                <span className="text-xs text-text-muted">Backed by</span>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-display font-semibold text-sm text-text-primary uppercase tracking-wider mb-4">Explore</h4>
            <ul className="space-y-2.5">
              {[
                { href: '/stories', label: 'Student Stories' },
                { href: '/map', label: 'School Map' },
          ...
          {/* About */}
          <div>
            <h4 className="font-display font-semibold text-sm text-text-primary uppercase tracking-wider mb-4">About</h4>
            <ul className="space-y-2.5">
              {[
                { href: '/about#what-we-do', label: 'Our Mission' },
                { href: 'https://bclindia.in/', label: 'BCL India' },
                { href: '/about#partners', label: 'Partners & CSR' },
          ...
          {/* Contact */}
          <div>
            <h4 className="font-display font-semibold text-sm text-text-primary uppercase tracking-wider mb-4">Get in Touch</h4>
